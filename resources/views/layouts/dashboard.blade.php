...
<body class="bg-gray-200 flex h-screen">
    ...
    <div class="w-64 bg-gray-200 shadow-lg text-gray-800 min-h-full flex flex-col fixed top-0 left-0 z-20 transition-all duration-300">
        ...
        <div class="flex-1 overflow-y-auto border-t border-gray-300">
            <ul class="mt-6 px-4">
                <li class="mb-2">
                    <a href="{{ route('dashboard.menu1') }}" class="flex items-center text-gray-700 hover:bg-gray-300 py-2 px-4 rounded-lg transition-colors duration-200 {{ request()->routeIs('dashboard.menu1') ? 'bg-gray-300 text-gray-800 shadow' : '' }}">
        ...
        <!-- Logout Button -->
        <div class="p-6">
            <a href="{{ route('logout') }}" class="flex items-center justify-center text-white bg-red-600 e py-2 px-4 rounded-lg bg-white">
        ...
        <div class="pt-24 px-8 pb-8">
            ...
            <nav class="text-gray-600 mb-6">
                <ol class="list-reset flex text-sm">
                    <li><a href="{{ route('dashboard.menu1') }}" class="text-blue-600 hover:underline">Home</a></li>
